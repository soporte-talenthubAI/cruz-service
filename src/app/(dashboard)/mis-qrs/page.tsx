                ...
                {entradas.map((entrada) => (
                  ...
                  >
                    <td className="px-4 py-3 min-w-0">
                      <p className="font-medium text-dark-100 truncate max-w-[120px] sm:max-w-[160px] lg:max-w-none">{entrada.nombreInvitado}</p>
                      <p className="text-xs text-dark-500 sm:hidden truncate">{entrada.dniInvitado}</p>
                      <p className="text-xs text-dark-500 md:hidden mt-0.5 truncate">{entrada.evento.nombre}</p>
                    </td>
